# this works with producer2.py, along with the payment_consumer.py to show the fanout exchange
import asyncio
...
async def notify(order: Order) -> None:
    print(f"[notification] sending confirmation email for order {order.order_id}")
